...
<div class="row row-overflow">
 <div class="col-xs-12 eqLogicThumbnailDisplay">
  ...
  <legend><i class="fas fa-table"></i> {{Mes dispositifs}}</legend>
  <div class="eqLogicThumbnailContainer">
      ...
      <form class="form-horizontal">
        <fieldset>
          <div class="form-group">
            <label class="col-sm-3 control-label">{{Nom de l'équipement joinTasker}}</label>
            <div class="col-sm-3">
...
?>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">{{Clé Join}}</label>
                        <div class="col-sm-3">
